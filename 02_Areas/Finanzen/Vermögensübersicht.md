...
- Scalable ETF-Sparplan: 250 €/Monat → **Ziel 300 €/M ab Mai** (nach Riester beitragsfrei)
- Bausparvertrag (Badenia, → Immobilie): 60 €/Monat
- Bauspardarlehen (Badenia, Tilgung): 96,82 €/Monat
- Generali Riester: 50 €/Monat → **beitragsfrei stellen, Anruf offen: 0221-3395-7007**

---

## TR-Cash: Notgroschen-Definition

| Kategorie | Betrag | Begründung |
|-----------|-------:|------------|
| **Notgroschen (fix)** | 6.700 € | 3 Monatsausgaben × Fixkosten + Lifestyle-Puffer 1.500 € |
| **Immo-EK + Hochzeitspuffer** | ~2.570 € | Rest des TR-Cash, arbeitet passiv mit Zinsen |

> [!important] Regel
> Notgroschen 6.700 € ist unantastbar. Alles darüber ist Immo-EK oder Hochzeits-Puffer – **nicht für ETF-Umschichtung** (andere Zeithorizonte).
