...
> [!note] Dieses File wird vom LLM gepflegt – nie manuell bearbeiten.
> Bei jedem `/ingest` wird hier eine neue Zeile eingetragen. Bei `/debrief` wenn Erkenntnisse eine Seite berühren ebenfalls. Ziel: Claude kann mit diesem Index sofort navigieren ohne alle Dateien zu lesen.

## Bücher & Persönlichkeiten
...
| Seite | Zusammenfassung | Tags | Zuletzt |
|-------|-----------------|------|---------|
| [[Hauskauf – Strategie & Finanzierung]] | Eigenkapital-Strategie, Finanzierungsoptionen, Timing. Verbunden mit Road to 100k. | #immobilie #finanzen | 2026-04 |
...
Aktivitäts-Log: [[../06_Metadata/log|log.md]]
